                ...
                <div 
                    ...
                    {this.state.isHover ? <div>
                        <svg width="50px" height="50px">
                            <line x1="40" y1="10" x2="10" y2="40" stroke-linecap="round" stroke-width="10" stroke="white"/>
                            <line x1="10" y1="10" x2="40" y2="40" stroke-linecap="round" stroke-width="10" stroke="white"/>
                        </svg>
                    </div>:<div>
                        <svg width="50px" height="50px">
                            <line x1="10" y1="10" x2="40" y2="10" stroke-linecap="round" stroke-width="10" stroke="white"/>
                            <line x1="10" y1="25" x2="40" y2="25" stroke-linecap="round" stroke-width="10" stroke="white"/>
                            <line x1="10" y1="40" x2="40" y2="40" stroke-linecap="round" stroke-width="10" stroke="white"/>
                        </svg>
                    </div>}
                </div>
            </button>
...
class ToutesOption extends React.Component {
    ...
    render(){
        return <React.Fragment>
            <ul>
                {this.touteslesoptions.map(index => <li>{index}</li>)}
            </ul>
        </React.Fragment>
    }
}
